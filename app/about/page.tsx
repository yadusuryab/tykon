      ...
      <div className="about-page">
        ...
        <section className="relative flex flex-col items-center justify-center text-center
          ...
          <div className="fade-up relative mb-10">
            <div className="brand-ring w-24 h-24 md:w-28 md:h-28 mx-auto shadow-[0_0_60px_rgba(20,184,154,0.2)]">
              <div className="brand-ring-inner">
                <span className="serif text-white text-2xl md:text-3xl font-light tracking-wider">kerala_kicks</span>
              </div>
            </div>
          </div>
          ...
          <p className="fade-up delay-3 mt-7 text-[var(--muted)] text-sm md:text-base
            ...
            We believe great design should be accessible. kerala_kicks brings you carefully
          ...
          <div className="fade-up delay-4 flex items-center gap-3 mt-10 flex-wrap justify-center">
            ...
            <a href="https://instagram.com/kerala_kicks_online" target="_blank" rel="noopener noreferrer"
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-[var(--muted)] text-sm leading-relaxed font-light">
                <p>
                  kerala_kicks started as a simple idea: premium watches shouldn't cost a fortune,
              ...
              <div className="glass rounded-3xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="relative space-y-6">
                  {[
                    ...
                    { label: "Instagram", value: "@kerala_kicks_online" },
