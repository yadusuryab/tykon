  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn how keralakicks uses cookies to enhance your browsing experience." />
      </Head>
      <div className="container mx-auto p-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            <strong>Company:</strong> Refers to keralakicks ("the Company", "We", "Us", or "Our").
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> Refers to keralakicks, accessible from
            <a href="https://keralakicks.co.in" target="_blank" rel="noopener noreferrer" className="text-blue-500"> keralakicks.co.in</a>.
          </li>
          <li>
        ...
        <p>
          ...
          <a
            href="https://keralakicks.co.in/contact"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500"
          >
            keralakicks.co.in/contact
          </a>
          .
        </p>
      </div>
