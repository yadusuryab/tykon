...
function CategoryCard({ name, image, slug, productCount }: CategoryCardProps) {
  ...
  return (
    ...
    >
      <div
        className="relative h-[280px] sm:h-[320px] rounded-md overflow-hidden bg-neutral-100"
        style={{
          boxShadow: hovered
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 p-4">
          <h3
            className="text-white font-bold font-serif  text-2xl tracking-tighter italic lowercase "
            style={{
